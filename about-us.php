...
<div class="sister-page-hero-container">
    <div class="sister-page-hero-content"> 
        ...
        <img src="./assets/images/about-us.webp" alt="about us"> <br>
        <h1>About Us</h1>
        <p>
        An Online Platform that connects the Grassroot Level Farmers with the Veterinarians with an 
        ...
        <p>
        The on-farm healthcare and management service in the Indian livestock industry is still at a 
        ...
        <p>
        Hence, over the years, an intense need for creating a virtual platform for the livestock healthcare 
        ...
        <p>
         Dr. AgriVet, the Livestock Health Care Advisory Online Platform is the first of its kind in India. 
        ...
        <p>
        Headquartered in Kolkata, DR. AGRIVET ADVISORY LLP is the developer, owner, and operator of this service. 
        ...
        <p>
        Operating on a robust technology platform that ensures continued service with minimum downtime, Dr. 
        ...
        <p>
        In this post-pandemic new-normal environment, DR. AGRIVET ADVISORY LLP is delighted to dedicate this 
